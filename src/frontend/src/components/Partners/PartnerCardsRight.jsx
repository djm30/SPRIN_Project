...
<Card className="max-w-[360px] md:max-w-none xl:w-96 xl:h-[17rem] flex flex-col py-12 px-5 space-y-10 ">
    ...
    <div>
      <p>Summary: </p>
      <p>To provide a zero suicide model and to move suicide prevention work higher on Assembly agenda</p>
      <p>Website:</p>
      <a
  ...
  >
    {/* CARD HEADER */}
    <h4 className="text-2xl font-display text-center">Family Voices Forum</h4>
    {/* CARD ICON */}
    <div>
      <p>Summary: </p>
      <p>Represent those bereaved by suicide to government and decision makers</p>
      <p>Website:</p>
      <a
